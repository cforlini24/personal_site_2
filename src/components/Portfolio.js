...
const Portfolio = () => {
    return(
    <div className="container w-full my-5 flex flex-col items-center md:mx-auto md:flex-row md:h-auto md:justify-around md:content-center md:py-40 md:flex-wrap ">
