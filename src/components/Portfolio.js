...
import { Card, CardBody, CardHeader, Typography, Button, CardFooter } from "@material-tailwind/react";
...
const Portfolio = () => {
    ...
    <div className="container w-full my-5 flex flex-col items-center md:mx-auto md:flex-row md:justify-around md:content-center md:flex-wrap md:overflow-hidden mb-60 md:content-between">
        <Card id="projThree" className = "my-5 w-96 slide-in-bottom md:w-1/3  md:m-5 md:mb-20">
            ...
            <a href="https://thevinylfrontier.netlify.app"><Typography variant="h3" id="puppyTitle">The Vinyl Frontier</Typography></a>
                ...
                <a href="https://github.com/The-Vinyl-Fontiers/TheVinylFrontier"><Button className="bg-blue text-xl">Repo</Button></a> 
                <a href="https://thevinylfrontier.netlify.app"><Button className="bg-blue text-xl ">Site</Button></a>
                </CardFooter>
            </CardBody>
        </Card>
        <Card id="projThree" className = "my-5 w-96 slide-in-bottom-delay md:w-1/3  md:m-5 md:mb-20">
            ...
            <CardFooter className="flex w-full justify-around">
                <a href="https://github.com/cforlini24/puppy_bowl"><Button className="bg-blue text-xl">Repo</Button> </a>
                <a href="https://sensational-semifreddo-ffbfd6.netlify.app"><Button className="bg-blue text-xl ">Site</Button></a>
                </CardFooter>
        </Card>
        <Card id="projOne" className = "my-5 w-96 slide-in-bottom-delay-2 md:w-1/3  md:m-5">
            ...
            <CardFooter className="flex w-full justify-around">
                <a href="https://github.com/cforlini24/cookie_clicker"><Button className="bg-blue text-xl">Repo</Button></a>
                <a href="https://coruscating-tarsier-20ea4b.netlify.app"><Button className="bg-blue text-xl ">Site</Button></a>
                </CardFooter>
        </Card>
        <Card id="projTwo" className = "my-5 w-96 slide-in-bottom-delay-3 md:w-1/3  md:m-5">
            ...
            <CardFooter className="flex w-full justify-around">
                <a href="https://github.com/cforlini24/arcade"><Button className="bg-blue text-xl">Repo</Button></a>
                <a href="https://chasesarcade.netlify.app"><Button className="bg-blue text-xl ">Site</Button></a>
             </CardFooter>
        </Card>
